...
## Quick Start
To get started with the blog, simply clone the repository and navigate to the blog directory:
```bash
git clone https://github.com/dvthanh19/vitiane_tech_blog.git
```
...
...
- Commit Messages: `<commit_purpose>: [<blog_name>] <short_description>`, where:
    - commit_purpose: 
